...
//    }
//
////    func unzipAndReadUserJson(fileName: String, folderName: String) throws -> User {
////        guard let folderURL = getDocumentsDirectory()?.appendingPathComponent(folderName) else {
////            throw FileManagerError.invalidDirectory
////        }
////
////        guard let zipFileURL = Bundle.main.url(forResource: fileName, withExtension: "zip") else {
////            throw FileManagerError.missingFile
////        }
////
////        do {
////            let unzipResult: () = try SSZipArchive.unzipFile(atPath: zipFileURL.absoluteString, toDestination: folderURL.absoluteString, overwrite: true, password: nil)
////            print("Unzip result: \(unzipResult)")
////        } catch {
////            throw FileManagerError.failedToUnzipFile
////        }
////
////        let userJsonURL = folderURL.appendingPathComponent("user.json")
////
////        guard let userJsonData = try? Data(contentsOf: userJsonURL) else {
////            throw FileManagerError.failedToReadFile
////        }
////
////        print("User JSON data: \(String(data: userJsonData, encoding: .utf8) ?? "")")
////
////        let decoder = JSONDecoder()
////
////        do {
////            let user = try decoder.decode(User.self, from: userJsonData)
////            return user
////        } catch {
////            throw FileManagerError.failedToDecodeJSON
////        }
////    }
////
